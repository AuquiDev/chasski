...
class DBCheckPoints02Page extends StatefulWidget {
  const DBCheckPoints02Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints02Page> createState() => _DBCheckPoints02PageState();
}

class _DBCheckPoints02PageState extends State<DBCheckPoints02Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr02>(context);
    ...
    final dataProvider = Provider.of<TCheckP02Provider>(context);
