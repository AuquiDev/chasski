...
class DBCheckPoints011Page extends StatefulWidget {
  const DBCheckPoints011Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints011Page> createState() => _DBCheckPoints011PageState();
}

class _DBCheckPoints011PageState extends State<DBCheckPoints011Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr011>(context);
    ...
    final dataProvider = Provider.of<TCheckP011Provider>(context);
