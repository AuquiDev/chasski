...
class DBCheckPoints020METAPage extends StatefulWidget {
  const DBCheckPoints020METAPage({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints020METAPage> createState() => _DBCheckPoints020METAPageState();
}

class _DBCheckPoints020METAPageState extends State<DBCheckPoints020METAPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr0META>(context);
    ...
    final dataProvider = Provider.of<TCheckP020METAProvider>(context);
