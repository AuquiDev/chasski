...
class DBCheckPoints013Page extends StatefulWidget {
  const DBCheckPoints013Page({
     required this.nombre
  });
 final String nombre;

  @override
  State<DBCheckPoints013Page> createState() => _DBCheckPoints013PageState();
}

class _DBCheckPoints013PageState extends State<DBCheckPoints013Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr013>(context);
    ...
    final dataProvider = Provider.of<TCheckP013Provider>(context);
