...
class DBCheckPoints08Page extends StatefulWidget {
  const DBCheckPoints08Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints08Page> createState() => _DBCheckPoints08PageState();
}

class _DBCheckPoints08PageState extends State<DBCheckPoints08Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr08>(context);
    ...
    final dataProvider = Provider.of<TCheckP08Provider>(context);
