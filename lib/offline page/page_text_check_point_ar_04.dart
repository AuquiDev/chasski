...
class DBCheckPoints04Page extends StatefulWidget {
  const DBCheckPoints04Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints04Page> createState() => _DBCheckPoints04PageState();
}

class _DBCheckPoints04PageState extends State<DBCheckPoints04Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr04>(context);
    ...
    final dataProvider = Provider.of<TCheckP04Provider>(context);
