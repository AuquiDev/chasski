...
class DBCheckPoints05Page extends StatefulWidget {
  const DBCheckPoints05Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints05Page> createState() => _DBCheckPoints05PageState();
}

class _DBCheckPoints05PageState extends State<DBCheckPoints05Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr05>(context);
    ...
    final dataProvider = Provider.of<TCheckP05Provider>(context);
