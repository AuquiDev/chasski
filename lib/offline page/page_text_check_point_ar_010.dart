...
class DBCheckPoints010Page extends StatefulWidget {
  const DBCheckPoints010Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints010Page> createState() => _DBCheckPoints010PageState();
}

class _DBCheckPoints010PageState extends State<DBCheckPoints010Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr010>(context);
    ...
    final dataProvider = Provider.of<TCheckP010Provider>(context);
