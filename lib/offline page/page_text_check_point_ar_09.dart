...
class DBCheckPoints09Page extends StatefulWidget {
  const DBCheckPoints09Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints09Page> createState() => _DBCheckPoints09PageState();
}

class _DBCheckPoints09PageState extends State<DBCheckPoints09Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr09>(context);
    ...
    final dataProvider = Provider.of<TCheckP09Provider>(context);
