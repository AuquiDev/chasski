...
class DBCheckPoints07Page extends StatefulWidget {
  const DBCheckPoints07Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints07Page> createState() => _DBCheckPoints07PageState();
}

class _DBCheckPoints07PageState extends State<DBCheckPoints07Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr07>(context);
    ...
    final dataProvider = Provider.of<TCheckP07Provider>(context);
