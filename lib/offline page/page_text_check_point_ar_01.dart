...
class DBCheckPoints01Page extends StatefulWidget {
  const DBCheckPoints01Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints01Page> createState() => _DBCheckPoints01PageState();
}

class _DBCheckPoints01PageState extends State<DBCheckPoints01Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr01>(context);
    ...
    final dataProvider = Provider.of<TCheckP01Provider>(context);
