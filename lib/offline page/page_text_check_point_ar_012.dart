...
class DBCheckPoints012Page extends StatefulWidget {
  const DBCheckPoints012Page({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<DBCheckPoints012Page> createState() => _DBCheckPoints012PageState();
}

class _DBCheckPoints012PageState extends State<DBCheckPoints012Page> {
  ...
  Widget build(BuildContext context) {
    ...
    final dbProducto = Provider.of<DBCheckPointsAppProviderAr012>(context);
    ...
    final dataProvider = Provider.of<TCheckP012Provider>(context);
