...
class DBCheckPointsAppProviderAr06 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR06 crudDb = CrudDBCheckPointsAR06();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP06Provider>(context, listen: false);
