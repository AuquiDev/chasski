...
import 'package:chasski/sqllite/db_crud_check_ar_p01.dart';
...
class DBCheckPointsAppProviderAr01 with ChangeNotifier {
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP01Provider>(context, listen: false);
