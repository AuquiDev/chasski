...
import 'package:chasski/sqllite/db_crud_check_ar_p03.dart';
...
class DBCheckPointsAppProviderAr03 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR03 crudDb = CrudDBCheckPointsAR03();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP03Provider>(context, listen: false);
