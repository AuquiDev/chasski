...
import 'package:chasski/sqllite/db_crud_check_ar_p07.dart';
...
class DBCheckPointsAppProviderAr07 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR07 crudDb = CrudDBCheckPointsAR07();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP07Provider>(context, listen: false);
