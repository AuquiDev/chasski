...
import 'package:chasski/sqllite/crud%20check%20point/db_crud_check_ar_p00.dart';
...
class DBChPProvider00 with ChangeNotifier {
...
// No te olvides de llamarlo en el método get
  ...
  Future<void> syncLocalDataToServer({
    ...
    final dataProvider = Provider.of<TCheckP00Provider>(context, listen: false);
...
// Método para procesar cada lote de datos
  Future<void> _processBatchSync(
    ...
    TCheckP00Provider dataProvider,
