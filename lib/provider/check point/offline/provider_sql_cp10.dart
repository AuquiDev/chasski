...
import 'package:chasski/sqllite/crud%20check%20point/db_crud_check_ar_p010.dart';
...
class DBChPProvider10 with ChangeNotifier {
...
// Método para procesar cada lote de datos
  Future<void> _processBatchSync(
    ...
    TCheckP010Provider dataProvider,
