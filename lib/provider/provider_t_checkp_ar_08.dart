...
import 'package:chasski/poketbase/t_check_p_arp08.dart';
// import 'package:chasski/poketbase/t_check_p_arp07.dart';
// import 'package:chasski/poketbase/t_check_p_arp06.dart';
// import 'package:chasski/poketbase/t_check_p_arp05.dart';
// import 'package:chasski/poketbase/t_check_p_arp04.dart';
...
class TCheckP08Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TCheckPoitns_AR08.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TCheckPoitns_AR08.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TCheckPoitns_AR08.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TCheckPoitns_AR08.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chp_8_punto').subscribe('*', (e) {
