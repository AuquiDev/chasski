...
import 'package:chasski/sqllite/db_crud_check_ar_p020meta.dart';
import 'package:flutter/material.dart';
import 'package:chasski/sqllite/db_create_local_storage.dart';
import 'package:chasski/utils/custom_text.dart';
import 'package:provider/provider.dart';

class DBCheckPointsAppProviderAr0META with ChangeNotifier {
  ...
  CrudDBCheckPointsAR0META crudDb = CrudDBCheckPointsAR0META();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP020METAProvider>(context, listen: false);
