...
import 'package:chasski/poketbase/t_check_p_arp020meta.dart';
import 'package:flutter/material.dart';
import 'package:chasski/api/path_key_api.dart';
import 'package:pocketbase/pocketbase.dart';

class TCheckP020METAProvider with ChangeNotifier {
  List<TCheckPointsModel> listAsistencia = [];

  TCheckP020METAProvider() {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TCheckPoitns_AR0META.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TCheckPoitns_AR0META.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TCheckPoitns_AR0META.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TCheckPoitns_AR0META.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chpr_meta').subscribe('*', (e) {
