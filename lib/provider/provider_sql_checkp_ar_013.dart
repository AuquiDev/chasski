...
import 'package:chasski/sqllite/db_crud_check_ar_p13.dart';
import 'package:flutter/material.dart';
import 'package:chasski/sqllite/db_create_local_storage.dart';
import 'package:chasski/utils/custom_text.dart';
import 'package:provider/provider.dart';

class DBCheckPointsAppProviderAr013 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR013 crudDb = CrudDBCheckPointsAR013();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP013Provider>(context, listen: false);
