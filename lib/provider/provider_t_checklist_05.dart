...
class TCheckList05Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TChecklist_05.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TChecklist_05.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TChecklist_05.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TChecklist_05.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chl_5_buses').subscribe('*', (e) {
