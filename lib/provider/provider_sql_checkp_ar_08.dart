...
import 'package:chasski/sqllite/db_crud_check_ar_p08.dart';
import 'package:flutter/material.dart';
import 'package:chasski/sqllite/db_create_local_storage.dart';
import 'package:chasski/utils/custom_text.dart';
import 'package:provider/provider.dart';

class DBCheckPointsAppProviderAr08 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR08 crudDb = CrudDBCheckPointsAR08();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP08Provider>(context, listen: false);
