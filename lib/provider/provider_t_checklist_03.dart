...
import 'package:chasski/poketbase/t_check_list_03.dart';
import 'package:flutter/material.dart';
import 'package:chasski/api/path_key_api.dart';
import 'package:pocketbase/pocketbase.dart';

class TCheckList03Provider with ChangeNotifier {
  List<TChekListmodel01> listAsistencia = [];

  TCheckList03Provider() {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TChecklist_03.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TChecklist_03.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TChecklist_03.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TChecklist_03.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chl_3_entrega_kits').subscribe('*', (e) {
