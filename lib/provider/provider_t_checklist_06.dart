...
import 'package:chasski/poketbase/t_check_list_06.dart';
...
class TCheckList06Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TChecklist_06.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TChecklist_06.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TChecklist_06.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TChecklist_06.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chl_6_entrega_medallas').subscribe('*', (e) {
