...
class TCheckP07Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TCheckPoitns_AR07.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TCheckPoitns_AR07.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TCheckPoitns_AR07.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TCheckPoitns_AR07.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chp_7_punto').subscribe('*', (e) {
