...
class DBCheckPointsAppProviderAr011 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR011 crudDb = CrudDBCheckPointsAR011();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP011Provider>(context, listen: false);
