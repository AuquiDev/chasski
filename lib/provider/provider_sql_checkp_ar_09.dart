...
import 'package:chasski/sqllite/db_crud_check_ar_p09.dart';
import 'package:flutter/material.dart';
import 'package:chasski/sqllite/db_create_local_storage.dart';
import 'package:chasski/utils/custom_text.dart';
import 'package:provider/provider.dart';

class DBCheckPointsAppProviderAr09 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR09 crudDb = CrudDBCheckPointsAR09();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP09Provider>(context, listen: false);
