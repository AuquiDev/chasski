...
import 'package:chasski/poketbase/t_check_list_08.dart';
...
class TCheckList08Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TChecklist_08.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal,String? fileUrl, String? detalles}) async {
    ...
    await TChecklist_08.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal, String? fileUrl, String? detalles  }) async {
    ...
    await TChecklist_08.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TChecklist_08.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chl_8_devolucion_equipaje').subscribe('*', (e) {
