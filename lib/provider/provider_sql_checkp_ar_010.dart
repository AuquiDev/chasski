...
import 'package:chasski/sqllite/db_crud_check_ar_p010.dart';
...
class DBCheckPointsAppProviderAr010 with ChangeNotifier {
  ...
  CrudDBCheckPointsAR010 crudDb = CrudDBCheckPointsAR010();
...
//METODO SINCRONIZACION OFFLINE
  ...
  Future<void> syncLocalDataToServer(BuildContext context) async {
    ...
    final dataProvider =
        Provider.of<TCheckP010Provider>(context, listen: false);
