...
class TCheckP09Provider with ChangeNotifier {
  ...
  getTAsistenciaApp() async {
    List<RecordModel> response = await TCheckPoitns_AR09.getAsitenciaPk();
  ...
  bool? estado, String? nombre, String? dorsal }) async {
    ...
    await TCheckPoitns_AR09.postAsistenciaPk(data);
  ...
  bool? estado, String? nombre, String? dorsal  }) async {
    ...
    await TCheckPoitns_AR09.putAsitneciaPk(id: id, data: data);
  ...
  deleteTAsistenciaApp(String id) async {
    await TCheckPoitns_AR09.deleteAsistentciaPk(id);
    notifyListeners();
  }
  ...
  Future<void> realtime() async {
    await pb.collection('ar_chp_9_punto').subscribe('*', (e) {
