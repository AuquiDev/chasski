...
import 'dart:io';
// import 'package:chasski/sqlliteCRUD/db_create_tables.dart';
import 'package:chasski/sqllite/bd%20tables/db___create_tables.dart';
...
class DBLocalStorage {
  ...
  Future<Database> initDataBase() async {
    ...
    String path = join(directory.path, 'andesRace13.db');
