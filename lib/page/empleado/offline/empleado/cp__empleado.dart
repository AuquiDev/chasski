...
final titlepage = 'COLABORADORES';

String selectField = 'rol';

final items = ['estado', 'sexo', 'rol', 'Todos'];
...
class _DBEmpleadoPageState extends State<DBEmpleadoPage> {
  ...
  //BUSCADOR
  late List<TEmpleadoModel> filterSearch = [];
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TEmpleadoProvider>(context);
    final listServer = serverProvider.listaEmpleados;

    // Obtener y ordenar la lista de puntos de control desde la base de datos local
    final dbProviderSQL = Provider.of<DBEmpleadoProvider>(context);
    List<TEmpleadoModel> listaSQl = dbProviderSQL.listsql
      ..sort((a, b) => a.nombre.compareTo(b.nombre));

    // Determinar la lista de datos a mostrar: filtrada si hay criterios de búsqueda, de lo contrario, la lista ordenada
    List<TEmpleadoModel> searchProvider =
  ...
  void synedServerData({
    required DBEmpleadoProvider dbProviderSQL,
  ...
  void downloadData({
    required DBEmpleadoProvider dbProvider,
    required List<TEmpleadoModel> listaDatos,
    required String selectField,
  }) async {
...
class ProgreesCharWidgetAR extends StatelessWidget {
  ...
  final List<TEmpleadoModel> listServer;
  final List<TEmpleadoModel> toBeOmited;
  final List<TEmpleadoModel> toBeUpdate;
  final List<TEmpleadoModel> toBeCreated;
  final List<TEmpleadoModel> toBeDeleted;
  final List<TEmpleadoModel> tolocalExist;
