...
class SQLCheckPoint02 extends StatefulWidget {
  const SQLCheckPoint02({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint02> createState() => _SQLCheckPoint02State();
}

class _SQLCheckPoint02State extends State<SQLCheckPoint02> {
 ScreenshotController screenshotController = ScreenshotController();
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP02Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider02>(context);
  ...
  void synedServerData({
    required DBChPProvider02 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider02 dbProvider,
