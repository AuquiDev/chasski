...
class SQLCheckPoint04 extends StatefulWidget {
  const SQLCheckPoint04({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint04> createState() => _SQLCheckPoint04State();
}

class _SQLCheckPoint04State extends State<SQLCheckPoint04> {
 ScreenshotController screenshotController = ScreenshotController();
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP04Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider04>(context);
  ...
  void synedServerData({
    required DBChPProvider04 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider04 dbProvider,
