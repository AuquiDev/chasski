...
class SQLCheckPoint12 extends StatefulWidget {
  const SQLCheckPoint12({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint12> createState() => _SQLCheckPoint12State();
}

class _SQLCheckPoint12State extends State<SQLCheckPoint12> {
 ScreenshotController screenshotController = ScreenshotController();
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP012Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider12>(context);
  ...
  void synedServerData({
    required DBChPProvider12 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider12 dbProvider,
