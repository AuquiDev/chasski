...
class SQLCheckPoint07 extends StatefulWidget {
  const SQLCheckPoint07({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint07> createState() => _SQLCheckPoint07State();
}

class _SQLCheckPoint07State extends State<SQLCheckPoint07> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP07Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider07>(context);
  ...
  void synedServerData({
    required DBChPProvider07 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider07 dbProvider,
