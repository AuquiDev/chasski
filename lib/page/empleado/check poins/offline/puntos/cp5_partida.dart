...
class SQLCheckPoint05 extends StatefulWidget {
  const SQLCheckPoint05({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint05> createState() => _SQLCheckPoint05State();
}

class _SQLCheckPoint05State extends State<SQLCheckPoint05> {
 ScreenshotController screenshotController = ScreenshotController();
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP05Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider05>(context);
  ...
  void synedServerData({
    required DBChPProvider05 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider05 dbProvider,
