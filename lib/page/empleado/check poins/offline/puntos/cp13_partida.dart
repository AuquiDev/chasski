...
class SQLCheckPoint13 extends StatefulWidget {
  const SQLCheckPoint13({
     required this.nombre
  });
 final String nombre;

  @override
  State<SQLCheckPoint13> createState() => _SQLCheckPoint13State();
}

class _SQLCheckPoint13State extends State<SQLCheckPoint13> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP013Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider13>(context);
  ...
  void synedServerData({
    required DBChPProvider13 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider13 dbProvider,
