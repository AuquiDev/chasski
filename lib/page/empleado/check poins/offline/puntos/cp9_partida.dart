...
class SQLCheckPoint09 extends StatefulWidget {
  const SQLCheckPoint09({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint09> createState() => _SQLCheckPoint09State();
}

class _SQLCheckPoint09State extends State<SQLCheckPoint09> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP09Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider09>(context);
  ...
  void synedServerData({
    required DBChPProvider09 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider09 dbProvider,
