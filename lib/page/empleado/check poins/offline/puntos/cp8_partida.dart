...
class SQLCheckPoint08 extends StatefulWidget {
  const SQLCheckPoint08({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint08> createState() => _SQLCheckPoint08State();
}

class _SQLCheckPoint08State extends State<SQLCheckPoint08> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP08Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider08>(context);
  ...
  void synedServerData({
    required DBChPProvider08 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider08 dbProvider,
