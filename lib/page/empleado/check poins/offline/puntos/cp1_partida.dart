...
class SQLCheckPoint01 extends StatefulWidget {
  const SQLCheckPoint01({super.key, required this.nombre});
  final String nombre;

  @override
  State<SQLCheckPoint01> createState() => _SQLCheckPoint01State();
}

class _SQLCheckPoint01State extends State<SQLCheckPoint01> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP01Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider01>(context);
  ...
  void synedServerData({
    required DBChPProvider01 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider01 dbProvider,
