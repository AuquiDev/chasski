...
class SQLCheckPoint06 extends StatefulWidget {
  const SQLCheckPoint06({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint06> createState() => _SQLCheckPoint06State();
}

class _SQLCheckPoint06State extends State<SQLCheckPoint06> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP06Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider06>(context);
  ...
  void synedServerData({
    required DBChPProvider06 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider06 dbProvider,
