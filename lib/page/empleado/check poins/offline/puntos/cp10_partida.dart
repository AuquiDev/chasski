...
class SQLCheckPoint10 extends StatefulWidget {
  const SQLCheckPoint10({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint10> createState() => _SQLCheckPoint10State();
}

class _SQLCheckPoint10State extends State<SQLCheckPoint10> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP010Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider10>(context);
  ...
  void synedServerData({
    required DBChPProvider10 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider10 dbProvider,
