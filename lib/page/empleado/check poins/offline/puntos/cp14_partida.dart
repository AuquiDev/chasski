...
// import 'package:chasski/appData/sheety/sqldata/page_test_participantes.dart';
...
class SQLCheckPoint14 extends StatefulWidget {
  const SQLCheckPoint14({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint14> createState() => _SQLCheckPoint14State();
}

class _SQLCheckPoint14State extends State<SQLCheckPoint14> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP020METAProvider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider14>(context);
  ...
  void synedServerData({
    required DBChPProvider14 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider14 dbProvider,
