...
class SQLCheckPoint00 extends StatefulWidget {
  const SQLCheckPoint00({super.key, required this.nombre});
  final String nombre;

  @override
  State<SQLCheckPoint00> createState() => _DBParticiapntespageState();
}

class _DBParticiapntespageState extends State<SQLCheckPoint00> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP00Provider>(context);
  ...
  void synedServerData({
    required DBChPProvider00 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider00 dbProvider,
