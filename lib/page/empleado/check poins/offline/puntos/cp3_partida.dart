...
class SQLCheckPoint03 extends StatefulWidget {
  const SQLCheckPoint03({
    super.key,
 ...
 final String nombre;
  ...
  @override
  State<SQLCheckPoint03> createState() => _SQLCheckPoint03State();
}

class _SQLCheckPoint03State extends State<SQLCheckPoint03> {
  ...
  Widget build(BuildContext context) {
    ...
    final serverProvider = Provider.of<TCheckP03Provider>(context);
    ...
    final dbProviderSQL = Provider.of<DBChPProvider03>(context);
  ...
  void synedServerData({
    required DBChPProvider03 dbProviderSQL,
  ...
  void downloadData({
    required DBChPProvider03 dbProvider,
