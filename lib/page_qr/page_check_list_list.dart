...
import 'package:chasski/page_qr/check_list_list_routes.dart';
...
void mostrarDialogoSeleccion() {
  ...
  Widget build(BuildContext context) {
    ...
    // final listaCheckPSQlList =  Provider.of<DBTListCheckPoitns_ARProvider>(context).listsql;
    List<TListChekListModel> checkPList =
        // isffline ? listaCheckPSQlList : 
        listaCheckPServerList;
    //LISTA GRUPOS ALMACÉ
